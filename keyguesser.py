...
#############################################################################################################
inFileName = "RSVOTBJEM125006_JCOW414.enc" # Full name of the encrypted config backup file                    #
outFileName = "RSVOTBJEM125006_JCOW414.txt" # Name of output file if the decryption is successful             #
routerSerial = "RSVOTBJEM125006" # Your Router's Serial Number                                                #
routerSsid = "H8AbA"  # Default Router SSID without the 'JioFiber-' prefix                                  #
#############################################################################################################
